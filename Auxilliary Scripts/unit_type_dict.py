...
for file in os.listdir(dir):
    ...
    if not filename.endswith(".py"):
        with open(dir + "\\" + filename, 'r') as file:
            ...
            if result:
                unit_type_dict[filename.split(".")[0]] = result.group(1)


with open("C:\\Users\\kunde\\Documents\\GitHub\\EU4-MP-Statstool\\Statstool-Web\\files\\unit_type_dict.txt", "w") as file:
