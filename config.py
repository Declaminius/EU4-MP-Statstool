...
old_nations_list = ["RVA", "PRO", "ANS", "NOV", "ORL", "DTT", "ZAZ", "WES", "HTK", "LAN", "GEO"]
new_nations_list = ["WES", "KOJ", "FKN", "RUS", "FRA", "HAN", "UKR", "GBR", "JAP", "ITA", "PER"]
remove_nations_list = ["HUN", "SPA", "MOS", "CRI", "SAX", "LON", "BRI", "SLO"]
